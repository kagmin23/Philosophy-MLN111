          ...
          <Row gutter={[32, 32]} align="middle">
            ...
            <Col xs={24} md={12}>
              ...
              <Paragraph className="text-lg text-gray-700">
                Theo chủ nghĩa Mác - Lênin, con người không tồn tại độc lập mà
                luôn gắn liền với xã hội. Do đó, trách nhiệm cá nhân và trách
                nhiệm xã hội có mối quan hệ biện chứng chặt chẽ.
              </Paragraph>
            </Col>
          </Row>
        </div>
        ...
        <div className="container px-4 mx-auto">
          ...
          <Row gutter={[32, 32]}>
            <Col xs={24} md={8}>
              <Card hoverable className="h-full p-2">
                <Paragraph className="text-xl">
                  Đạo đức cách mạng theo tư tưởng Hồ Chí Minh là lòng trung
                  thành với lý tưởng, sự tận tụy vì lợi ích nhân dân và đất
                  nước.
                </Paragraph>
              </Card>
            </Col>
            <Col xs={24} md={8}>
              <Card hoverable className="h-full p-2 text-xl ">
                <Paragraph className="text-xl">
                  Trách nhiệm là yếu tố quan trọng tạo nên đạo đức cách mạng,
                  thể hiện qua hành động thực tiễn của mỗi cá nhân đối với tập
                  thể.
                </Paragraph>
              </Card>
            </Col>
            <Col xs={24} md={8}>
              <Card hoverable className="h-full p-2">
                <Paragraph className="text-xl">
                  Người có đạo đức cách mạng cao là người luôn ý thức trách
                  nhiệm của mình, dám chịu trách nhiệm và đặt lợi ích chung lên
                    ...
                    children: (
                      <div className="ml-2">
                        ...
                        <Text className="text-gray-600">
                          Yêu có trách nhiệm là không chỉ yêu bằng cảm xúc mà
                          còn có sự tôn trọng, quan tâm và sẵn sàng chịu trách
                  ...
                  },
                  {
                    ...
                    children: (
                      <div className="ml-2">
                        ...
                        <Text className="text-gray-600">
                          Một mối quan hệ bền vững không chỉ dựa vào tình cảm mà
                          còn phụ thuộc vào cách hai người ứng xử, thấu hiểu và
                          hỗ trợ nhau
                        </Text>
                      </div>
                    ),
